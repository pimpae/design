! function (e) {
	...
	! function (t, n) {
		...
		var k = function (e) {
			...
			for (t in n = se.support = {}, o = se.isXML = function (e) {
					...
					return a !== d && 9 === a.nodeType && a.documentElement && (h = (d = a).documentElement, g = !o(d), w !== d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.attributes = ce((function (e) {
						...
						h.appendChild(e).innerHTML = "<a id='" + b + "'></a><select id='" + b + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && v.push("[*^$]=" + $ + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || v.push("\\[" + $ + "*(?:value|" + _ + ")"), e.querySelectorAll("[id~=" + b + "-]").length || v.push("~="), e.querySelectorAll(":checked").length || v.push(":checked"), e.querySelectorAll("a#" + b + "+*").length || v.push(".#.+[+~]")
					})), ce((function (e) {
							...
							return 1 === r && 0 === i ? function (e) {
								...
								if (v) {
									...
									if (h = [a ? v.firstChild : v.lastChild], a && y) {
										...
										for (;
											(p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && ((c = (f = p[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [C, x]), p !== t)););
			...
			function Te(e, t, n, r, i, o) {
				return r && !r[b] && (r = Te(r)), i && !i[b] && (i = Te(i, o)), ue((function (o, a, s, l) {
					var u, c, f, p = [],
						...
						m = n ? i || (o ? e : h || r) ? [] : a : v;
					if (n && n(v, m, s, l), r)
						for (u = Ce(m, d), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (m[d[c]] = !(v[d[c]] = f));
					if (o) {
						if (i || e) {
							if (i) {
				...
				for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], l = a ? 1 : 0, c = be((function (e) {
					...
					if (n = r.relative[e[l].type]) p = [be(we(p), n)];
						...
						if ((n = r.filter[e[l].type].apply(null, e[l].matches))[b]) {
							...
							return Te(1 < l && we(p), 1 < l && xe(e.slice(0, l - 1).concat({
								value: " " === e[l - 2].type ? "*" : ""
							})).replace(W, "$1"), n, l < i && Se(e.slice(l, i)), i < o && Se(e = e.slice(i)), i < o && xe(e))
						}
						p.push(n)
					}
				return we(p)
		...
		}), S.ready.then = z.then, "complete" === a.readyState || "loading" !== a.readyState && !a.documentElement.doScroll ? n.setTimeout(S.ready) : (a.addEventListener("DOMContentLoaded", U), n.addEventListener("load", U));
		...
		S.event = {
			...
			add: function (e, t, n, r, i) {
				...
				if (v)
					for (n.handler && (n = (o = n).handler, i = o.selector), i && S.find.matchesSelector(se, i), n.guid || (n.guid = S.guid++), (l = v.events) || (l = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
						...
						}), u = (t = (t || "").match(M) || [""]).length; u--;) d = g = (s = ke.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = S.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = S.event.special[d] || {}, c = S.extend({
						type: d,
						origType: g,
						data: r,
						handler: n,
			...
			e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ae : je, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && S.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[S.expando] = !0
		}, S.Event.prototype = {
			constructor: S.Event,
		...
		function Be(e, t, n, r) {
			...
			var i, o, a, s, l, c, f = 0,
				...
				h = t[0],
				g = y(h);
			if (g || 1 < p && "string" == typeof h && !m.checkClone && Oe.test(h)) return e.each((function (i) {
				var o = e.eq(i);
			...
			if (p && (o = (i = Se(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
				...
				if (s)
					for (c = a[a.length - 1].ownerDocument, S.map(a, Me), f = 0; f < s; f++) l = a[f], me.test(l.type || "") && !Z.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && !l.noModule && S._evalUrl(l.src, {
		...
		S.extend({
			...
			clone: function (e, t, n) {
				...
				if (t)
					if (n)
						for (o = o || xe(e), a = a || xe(c), r = 0, i = o.length; r < i; r++) Ie(o[r], a[r]);
					else Ie(e, c);
		...
		function Ke(e) {
			return S.cssProps[e] || Qe[e] || (e in Ye ? e : Qe[e] = function (e) {
		...
		S.fn.extend({
			...
			toggleClass: function (e, t) {
				...
				return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : y(e) ? this.each((function (n) {
					...
					var t, i, o, a;
					if (r)
						for (i = 0, o = S(this), a = Tt(e); t = a[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
			...
			hasClass: function (e) {
				var t, n, r = 0;
				for (t = " " + e + " "; n = this[r++];)
					if (1 === n.nodeType && -1 < (" " + wt(Ct(n)) + " ").indexOf(t)) return !0;
				return !1
			}
		});
		var St = /\r/g;
		...
		S.extend(S.event, {
			trigger: function (e, t, r, i) {
				...
				if (s = d = l = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !Nt.test(v + S.event.triggered) && (-1 < v.indexOf(".") && (v = (m = v.split(".")).shift(), m.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[S.expando] ? e : new S.Event(v, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : S.makeArray(t, [e]), p = S.event.special[v] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, t))) {
					...
					for (o = 0;
						(s = g[o++]) && !e.isPropagationStopped();) d = s, e.type = 1 < o ? u : p.bindType || v, (f = (Z.get(s, "events") || {})[e.type] && Z.get(s, "handle")) && f.apply(s, t), (f = c && s[c]) && f.apply && K(s) && (e.result = f.apply(s, t), !1 === e.result && e.preventDefault());
					return e.type = v, i || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), t) || !K(r) || c && y(r[v]) && !x(r) && ((l = r[c]) && (r[c] = null), S.event.triggered = v, e.isPropagationStopped() && d.addEventListener(v, Et), r[v](), e.isPropagationStopped() && d.removeEventListener(v, Et), S.event.triggered = void 0, l && (r[c] = l)), e.result
				}
			},
		...
		zt.href = kt.href, S.extend({
			...
			ajax: function (e, t) {
				...
				for (p in (f = S.event && h.global) && 0 == S.active++ && S.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Mt.test(h.type), i = h.url.replace(_t, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (jt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace($t, "$1"), d = (jt.test(i) ? "&" : "?") + "_=" + At++ + d), h.url = i + d), h.ifModified && (S.lastModified[i] && T.setRequestHeader("If-Modified-Since", S.lastModified[i]), S.etag[i] && T.setRequestHeader("If-None-Match", S.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : h.accepts["*"]), h.headers) T.setRequestHeader(p, h.headers[p]);
				...
				function N(e, t, a, s) {
					var u, p, d, b, w, C = t;
					c || (c = !0, l && n.clearTimeout(l), r = void 0, o = s || "", T.readyState = 0 < e ? 4 : 0, u = 200 <= e && e < 300 || 304 === e, a && (b = function (e, t, n) {
					...
					}(h, b, T, u), u ? (h.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (S.lastModified[i] = w), (w = T.getResponseHeader("etag")) && (S.etag[i] = w)), 204 === e || "HEAD" === h.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = b.state, p = b.data, u = !(d = b.error))) : (d = C, !e && C || (C = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || C) + "", u ? m.resolveWith(g, [p, C, T]) : m.rejectWith(g, [T, C, d]), T.statusCode(x), x = void 0, f && v.trigger(u ? "ajaxSuccess" : "ajaxError", [T, h, u ? p : d]), y.fireWith(g, [T, C]), f && (v.trigger("ajaxComplete", [T, h]), --S.active || S.event.trigger("ajaxStop")))
				}
				return T
			},
		...
		S.ajaxSetup({
			...
			if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Jt, "$1" + i) : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
		...
		}, S.isArray = Array.isArray, S.parseJSON = JSON.parse, S.nodeName = L, S.isFunction = y, S.isWindow = x, S.camelCase = Q, S.type = C, S.now = Date.now, S.isNumeric = function (e) {
			var t = S.type(e);
	...
	"undefined" != typeof window && (window.PR_SHOULD_USE_CONTINUATION = !0),
		function () {
			...
			function T(e, t, n) {
				...
				return o.innerHTML = "<pre>" + e + "</pre>", o = o.firstChild, r && y(o, r, !0), C({
					langExtension: i,
					numberLines: r,
					sourceNode: o,
					pre: 1,
					...
					for (var r = e.PR_SHOULD_USE_CONTINUATION ? f.now() + 250 : 1 / 0; p < s.length && f.now() < r; p++) {
						...
						if ((a !== w || g.test(T)) && !v.test(T)) {
							...
							if (!S) {
								...
								var R = a.linenums;
								(R = "true" === R || +R) || (R = !!(R = T.match(/\blinenums\b(?::(\d+))?/)) && (!R[1] || !R[1].length || +R[1])), R && y(o, R, A), C({
									langExtension: j,
									sourceNode: o,
									numberLines: R,
									pre: A,
					...
					if (e(t).scrollTop() > r.parent().offset().top) {
						var n = function () {
							var t = e(window).scrollTop(),
								n = "";
							return t < e(".js-nav:eq(0)").offset().top ? n : (e(".js-nav").each((function (r) {
...
$(".tool").hover(function(){
    $(".tool .tooltext").text("Copy link to heading"); 
});
$('.tool').on('click', function() {
    //var clipboard = new Clipboard(".tool");
    var url = window.location.href;
    var vlq =  $(this).attr("data-clipboard-text");
    var copyCode = new Clipboard('.tool', {
	    text: function() {
	        return url+"#"+vlq;
	    }
	});
    $(this).find(".tooltext").text("Copied!"); 
});   